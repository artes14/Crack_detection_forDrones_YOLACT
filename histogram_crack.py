...
img = cv2.imread('data/cloud_croptest/20220804_161438_34.png', cv2.IMREAD_GRAYSCALE)
(iH, iW) = img.shape[:2]
# create a mask
mask = cv2.imread('data/cloud_croptest/20220804_161438_34_frame.png', cv2.IMREAD_GRAYSCALE)

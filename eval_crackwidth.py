...
# startDatetime:datetime.datetime=datetime.datetime(2022, 7, 28, 0, 0, 0),
#                     endDatetime:datetime.datetime=datetime.datetime(2022, 7, 29, 0, 0, 0)):
# startDatetime: datetime.datetime = datetime.datetime(2022, 8, 4, 15, 47, 51),
# endDatetime: datetime.datetime = datetime.datetime(2022, 8, 4, 16, 30, 37)):
...
eval_crackwidth('weightsrobo/crackroboflow_res50_2803_286000.pth', None, imagepath='cloudImages', savepath='data/0908_0231_clahe')